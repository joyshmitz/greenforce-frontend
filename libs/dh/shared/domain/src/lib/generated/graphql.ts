...
export type Query = {
  ...
  imbalancePricesForMonth: Array<ImbalancePriceDay>;
};
...
export type ImbalancePriceDay = {
  __typename: 'ImbalancePriceDay';
  date: Scalars['DateTime']['output'];
  status: ImbalancePriceStatus;
  priceDays: Array<ImbalancePrice>;
};
...
export const scalarTypePolicies = {
  ...
  ImbalancePriceDay: { fields: { date: dateTypePolicy } },
  ...
  ImbalancePrice: { fields: { timestampStart: dateTypePolicy, timestampEnd: dateTypePolicy } },
