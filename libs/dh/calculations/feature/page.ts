...
import { DhCalculationsTableComponent } from './table';
import { DhCalculationsFormComponent } from './form';
import { DhCalculationsDetailsComponent } from './details';

@Component({
  selector: 'dh-calculations-page',
  standalone: true,
  imports: [
    CommonModule,
    DhCalculationsDetailsComponent,
    DhCalculationsFormComponent,
...
export default class DhCalculationsPageComponent implements AfterViewInit, OnInit, OnDestroy {
  @ViewChild('batchDetails')
  batchDetails!: DhCalculationsDetailsComponent;
